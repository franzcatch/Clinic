...
/
ALTER TABLE SERVICE_CLINIC ADD CONSTRAINT SERVICE_CLINIC_FK1 FOREIGN KEY ( CLINIC_ID ) REFERENCES CLINIC ( CLINIC_ID )
/
ALTER TABLE SERVICE_CLINIC ADD CONSTRAINT SERVICE_CLINIC_FK2 FOREIGN KEY ( SERVICE_ID ) REFERENCES SERVICE ( SERVICE_ID )
/
