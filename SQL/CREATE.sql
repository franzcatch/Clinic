...
/
ALTER TABLE ENTITY ADD CONSTRAINT PERSON_PK PRIMARY KEY ( ENTITY_ID )
/
ALTER TABLE ENTITY ADD CONSTRAINT ENTITY_UC1 UNIQUE (TAX_ID)
/
...
/
CREATE SEQUENCE ROLES_S START WITH 1 ORDER
/
